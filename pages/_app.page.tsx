...
export default function MyApp(props: MyAppProps) {
  ...
  return (
    <CacheProvider value={emotionCache}>
      ...
      <Meta
        title={'The Premier Lending Protocol on Taraxa'}
        description={
          'Taralend is an Open Source Protocol to create Non-Custodial Liquidity Markets to earn interest on supplying and borrowing assets with a variable or stable interest rate. The protocol is designed for easy integration into your products and services.'
        }
        imageUrl="https://app.taralend.xyz/taralend-logo.png"
      />
      <NoSsr>
        <LanguageProvider>
